...
Business Information Systems student (Minor: Psychology) with a strong focus on DevOps, AI systems, and scalable infrastructure engineering.

Currently working as a DevOps Engineer in the insurance sector, where I focus on automation, monitoring, and workflow optimization to bridge complex IT infrastructures with real business value.

My academic work includes research on AI-driven computer vision pipelines for urban vegetation analysis using state-of-the-art foundation models such as GroundingDINO and Segment Anything (SAM).

Beyond technology, I bring discipline, teamwork, and a high-performance mindset from competing as a semi-professional athlete in the 2nd German Volleyball Bundesliga.
...
- Transformer-based detectors (DINO)
...
- Developed robustness experiments for shadows, dense canopy coverage, and mixed urban environments
...
- Geospatial utility tooling
- Research documentation & lab notebooks

🔗 https://github.com/semantic-systems/tree-crown-detection-lueneburg.git
